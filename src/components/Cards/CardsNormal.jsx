export default function CardsNormal({ head, content, img, author }) {
  return (
    <>
      <div className="bg-white overflow-hidden relative max-w-sm p-6 w-[300px] max-lg:w-[220px] max-lg:h-auto max-lg:min-h-[300px] rounded-lg shadow-lg text-white">
        ...
        <div className="pt-6 border-b border-[#2c3a4c] mb-4">
          <a
            href="#"
            className="text-[#14253d] font-bold hover:text-indigo-400 transition-colors"
          >
            <h3 className="text-2xl max-lg:text-xl font-medium mb-4">{head}</h3>
          </a>
          <p className="text-[#8bacda] text-md max-lg:text-sm mb-6 leading-relaxed">
            {content}
          </p>
        </div>
